...
#include "dcl_input_ps_sgv.hpp"

namespace alys::shader::detail
{
	instruction_t dcl_input_ps_sgv::read(utils::bit_buffer_le& input_buffer)
	{
	...
	void dcl_input_ps_sgv::write(utils::bit_buffer_le& output_buffer, const instruction_t& instruction)
	{
	...
	void dcl_input_ps_sgv::dump(utils::string_writer& buffer, const instruction_t& instruction)
	{
	...
	std::uint32_t dcl_input_ps_sgv::get_flags()
	{
