...
{
	instruction_t dcl_resource_structured::read(utils::bit_buffer_le& input_buffer, const std::uint32_t version)
	{
	...
	void dcl_resource_structured::write(utils::bit_buffer_le& output_buffer, const instruction_t& instruction, const std::uint32_t version)
	{
