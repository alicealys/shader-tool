...
#include "dcl_resource_structured.hpp"

namespace alys::shader::detail
{
	instruction_t dcl_resource_structured::read(utils::bit_buffer_le& input_buffer)
	{
	...
	void dcl_resource_structured::write(utils::bit_buffer_le& output_buffer, const instruction_t& instruction)
	{
	...
	void dcl_resource_structured::dump(utils::string_writer& buffer, const instruction_t& instruction)
	{
