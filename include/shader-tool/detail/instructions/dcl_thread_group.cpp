...
{
	instruction_t dcl_thread_group::read(utils::bit_buffer_le& input_buffer)
	{
	...
	void dcl_thread_group::write(utils::bit_buffer_le& output_buffer, const instruction_t& instruction)
	{
	...
	void dcl_thread_group::dump(utils::string_writer& buffer, const instruction_t& instruction)
	{
