...
{
	instruction_t dcl_max_output_vertex_count::read(utils::bit_buffer_le& input_buffer)
	{
	...
	void dcl_max_output_vertex_count::write(utils::bit_buffer_le& output_buffer, const instruction_t& instruction)
	{
	...
	void dcl_max_output_vertex_count::dump(utils::string_writer& buffer, const instruction_t& instruction)
	{
