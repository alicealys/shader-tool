...
{
	instruction_t dcl_thread_group_shared_memory_raw::read(utils::bit_buffer_le& input_buffer, const std::uint32_t version)
	{
	...
	void dcl_thread_group_shared_memory_raw::write(utils::bit_buffer_le& output_buffer, const instruction_t& instruction, const std::uint32_t version)
	{
	...
	void dcl_thread_group_shared_memory_raw::dump(utils::string_writer& buffer, const instruction_t& instruction, const std::uint32_t version)
	{
	...
	std::uint32_t dcl_thread_group_shared_memory_raw::get_flags()
	{
