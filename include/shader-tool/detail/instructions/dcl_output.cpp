...
#include "dcl_output.hpp"

namespace alys::shader::detail
{
	instruction_t dcl_output::read(utils::bit_buffer_le& input_buffer, const std::uint32_t version)
	{
	...
	void dcl_output::write(utils::bit_buffer_le& output_buffer, const instruction_t& instruction, const std::uint32_t version)
	{
	...
	void dcl_output::dump(utils::string_writer& buffer, const instruction_t& instruction, const std::uint32_t version)
	{
