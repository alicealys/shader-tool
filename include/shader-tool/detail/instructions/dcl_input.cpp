...
{
	instruction_t dcl_input::read(utils::bit_buffer_le& input_buffer, const std::uint32_t version)
	{
	...
	void dcl_input::write(utils::bit_buffer_le& output_buffer, const instruction_t& instruction, const std::uint32_t version)
	{
	...
	void dcl_input::dump(utils::string_writer& buffer, const instruction_t& instruction, const std::uint32_t version)
	{
