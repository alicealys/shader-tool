...
{
	instruction_t dcl_tess_output_primitive::read(utils::bit_buffer_le& input_buffer, const std::uint32_t version)
	{
	...
	void dcl_tess_output_primitive::write(utils::bit_buffer_le& output_buffer, const instruction_t& instruction, const std::uint32_t version)
	{
		write_opcode(output_buffer, instruction.opcode, 1);
	}

	void dcl_tess_output_primitive::dump(utils::string_writer& buffer, const instruction_t& instruction, const std::uint32_t version)
	{
