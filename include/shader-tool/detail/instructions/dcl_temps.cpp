...
{
	instruction_t dcl_temps::read(utils::bit_buffer_le& input_buffer, const std::uint32_t version)
	{
	...
	void dcl_temps::write(utils::bit_buffer_le& output_buffer, const instruction_t& instruction, const std::uint32_t version)
	{
	...
	void dcl_temps::dump(utils::string_writer& buffer, const instruction_t& instruction, const std::uint32_t version)
	{
