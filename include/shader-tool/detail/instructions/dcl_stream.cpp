...
{
	instruction_t dcl_stream::read(utils::bit_buffer_le& input_buffer)
	{
	...
	void dcl_stream::write(utils::bit_buffer_le& output_buffer, const instruction_t& instruction)
	{
	...
	void dcl_stream::dump(utils::string_writer& buffer, const instruction_t& instruction)
	{
