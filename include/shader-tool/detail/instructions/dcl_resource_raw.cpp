...
{
	instruction_t dcl_resource_raw::read(utils::bit_buffer_le& input_buffer, const std::uint32_t version)
	{
	...
	void dcl_resource_raw::write(utils::bit_buffer_le& output_buffer, const instruction_t& instruction, const std::uint32_t version)
	{
	...
	void dcl_resource_raw::dump(utils::string_writer& buffer, const instruction_t& instruction, const std::uint32_t version)
	{
	...
	std::uint32_t dcl_resource_raw::get_flags()
	{
