...
{
	instruction_t dcl_input_siv::read(utils::bit_buffer_le& input_buffer)
	{
	...
	void dcl_input_siv::write(utils::bit_buffer_le& output_buffer, const instruction_t& instruction)
	{
	...
	void dcl_input_siv::dump(utils::string_writer& buffer, const instruction_t& instruction)
	{
