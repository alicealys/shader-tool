...
{
	instruction_t interface_call::read(utils::bit_buffer_le& input_buffer)
	{
	...
	void interface_call::write(utils::bit_buffer_le& output_buffer, const instruction_t& instruction)
	{
	...
	void interface_call::dump(utils::string_writer& buffer, const instruction_t& instruction)
	{
