...
#include "dcl_input_sgv.hpp"

namespace alys::shader::detail
{
	instruction_t dcl_input_sgv::read(utils::bit_buffer_le& input_buffer, const std::uint32_t version)
	{
	...
	void dcl_input_sgv::write(utils::bit_buffer_le& output_buffer, const instruction_t& instruction, const std::uint32_t version)
	{
	...
	void dcl_input_sgv::dump(utils::string_writer& buffer, const instruction_t& instruction, const std::uint32_t version)
	{
	...
	std::uint32_t dcl_input_sgv::get_flags()
	{
