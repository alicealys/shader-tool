...
{
	instruction_t dcl_output_sgv::read(utils::bit_buffer_le& input_buffer)
	{
	...
	void dcl_output_sgv::write(utils::bit_buffer_le& output_buffer, const instruction_t& instruction)
	{
	...
	void dcl_output_sgv::dump(utils::string_writer& buffer, const instruction_t& instruction)
	{
