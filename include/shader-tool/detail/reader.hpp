...
namespace alys::shader::detail
{
	...
	operand_extended_t read_extended_operand(alys::utils::bit_buffer_le& input_buffer, bool& extended);
	operand_t read_operand(alys::utils::bit_buffer_le& input_buffer);
